...
class MyFrame2 ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		self.bSizer17 = wx.BoxSizer( wx.VERTICAL )
		...
		self.m_panel15.SetSizer( self.bSizer20 )
		self.m_panel15.Layout()
		self.bSizer20.Fit( self.m_panel15 )
		...
		self.ideaCreateDate = wx.DatePickerCtrl( self.m_panel17, wx.ID_ANY, wx.DefaultDateTime, wx.DefaultPosition, wx.DefaultSize, wx.DP_ALLOWNONE|wx.DP_DEFAULT )
		fgSizer4.Add( self.ideaCreateDate, 0, wx.ALL, 5 )
		
		self.ideaStartDate = wx.DatePickerCtrl( self.m_panel17, wx.ID_ANY, wx.DefaultDateTime, wx.DefaultPosition, wx.DefaultSize, wx.DP_ALLOWNONE|wx.DP_DEFAULT )
		...
		self.bSizer221.Add( fgSizer31, 1, wx.EXPAND, 0 )
		...
		self.bSizer221.Add( fgSizer41, 0, wx.EXPAND, 5 )
		...
		self.bSizer221.Add( bSizer241, 0, wx.EXPAND, 5 )
		
		
		self.m_panel171.SetSizer( self.bSizer221 )
		self.m_panel171.Layout()
		self.bSizer221.Fit( self.m_panel171 )
		self.bSizer211.Add( self.m_panel171, 1, wx.EXPAND |wx.ALL, 5 )
		
		
		self.IdeaInputPanel1.SetSizer( self.bSizer211 )
		self.IdeaInputPanel1.Layout()
		self.bSizer211.Fit( self.IdeaInputPanel1 )
		self.m_splitter8.SplitVertically( self.m_panel30, self.IdeaInputPanel1, 0 )
		self.bSizer41.Add( self.m_splitter8, 1, wx.EXPAND, 5 )
		
		
		self.ProjectPanel.SetSizer( self.bSizer41 )
		self.ProjectPanel.Layout()
		self.bSizer41.Fit( self.ProjectPanel )
		self.m_notebook2.AddPage( self.ProjectPanel, u"Projects", False )
		...
		self.bSizer18.Add( self.m_notebook2, 1, wx.EXPAND |wx.ALL, 0 )
		
		
		self.m_panel11.SetSizer( self.bSizer18 )
		self.m_panel11.Layout()
		self.bSizer18.Fit( self.m_panel11 )
		self.bSizer17.Add( self.m_panel11, 1, wx.EXPAND |wx.ALL, 5 )
		
		
		self.SetSizer( self.bSizer17 )
		self.Layout()
